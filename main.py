...
def handle_file(message):
    ...
    try:
        ...
        if not media_lang_code:
            bot.send_message(message.chat.id, f"❌ The language *{user_media_language_settings[uid]}* does not have a valid code for transcription. Please re-select the language.")
...
LANGUAGES = [
    ...
    {"name": "Filipino", "flag": "🇵🇭", "code": "fil"}, # Note: Faster-whisper might use 'tl' for Tagalog/Filipino depending on version, 'fil' is common.
    {"name": "Persian", "flag": "🇮🇷", "code": "fa"},
    {"name": "Amharic", "flag": "🇪🇹", "code": "am"},
    {"name": "Somali", "flag": "🇸🇴", "code": "so"},
    {"name": "Swedish", "flag": "🇸🇪", "code": "sv"},
    {"name": "Norwegian", "flag": "🇳🇴", "code": "no"}, # nb (Bokmål) or nn (Nynorsk) are more specific, 'no' is generic
