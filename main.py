...
def callback_set_media_language(call):
    ...
    bot.edit_message_text(
        ...
        text=f"✅ The transcription language for your media is set to: **{lang_display_name}**\n\n"
             "Now, please send your voice message, audio file, video note, or video file for me to transcribe. I support media files up to 20MB in size 📞 Need fresh bot for Text to audio ? use 👉🏻 @Voice_maker_robot ",
        parse_mode="Markdown"
    )
