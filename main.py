...
TTS_VOICES_BY_LANGUAGE = {
    ...
    "中文": [
        ...
        "zh-CN-YunjianNeural", "zh-TW-HsiaoChenNeural", 
        "zh-TW-YunJheNeural", "zh-HK-HiuMaanNeural", 
        "zh-HK-WanLungNeural"      
    ],
...
def start_handler(message):
    ...
    # Get user settings
    media_lang = get_user_media_language_setting_db(user_id_str) or "Not set"
    trans_lang = get_user_translation_language_db(user_id_str) or "Not set"
    summary_lang = get_user_summary_language_db(user_id_str) or "Not set"
    tts_voice = get_tts_user_voice_db(user_id_str) or "Not set"
    tts_pitch = get_tts_user_pitch_db(user_id_str)
    tts_rate = get_tts_user_rate_db(user_id_str)
