...
def save_user_language_settings():
    with open(user_language_settings_file, 'w') as f:
        json.dump(user_language_settings, indent=4)
...
# Bot's start time (for uptime calculation)
...
I'm your free transcription bot. Send me:
• Voice messages
• Video messages
• Audio files
to get them transcribed quickly and easily.

After transcription, you'll have options to **Translate** or **Summarize** the text.

If you need any help, just type /help. Enjoy!""",
        parse_mode="Markdown"
    )
...
def status_handler(message):
    ...
    # Calculate time components for total processing time
    total_sec_proc = int(total_processing_time)
    proc_hours = total_sec_proc // 3600
    proc_minutes = (total_sec_proc % 3600) // 60
    proc_seconds = total_sec_proc % 60
